...
exports.book_delete_get = function(req, res, next) {
    ...
    async.parallel({
        ...
        // Successful, so render.
        res.render('book_delete', { title: 'Delete Book', book: results.book, book_bookinstance: results.books_bookinstance } );
    });
...
exports.book_delete_post = function(req, res, next) {
    ...
    async.parallel({
        ...
        if (results.books_bookinstance.length > 0) {
            ...
            res.render('book_delete', { title: 'Delete Book', book: results.author, book_bookinstance: results.books_bookinstance } );
            return;
        }
        else {
